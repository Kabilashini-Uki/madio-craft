          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex justify-between items-center mb-8">
              <div className="flex items-center space-x-4">
                <button onClick={() => setShowFilters(!showFilters)}
                  className="lg:hidden flex items-center space-x-2 px-4 py-2 bg-white rounded-xl">
                  <FiFilter /><span>Filters</span>
                </button>
                <div className="flex items-center space-x-2">
                  <button onClick={() => setViewMode('grid')}
                    className={`p-2 rounded-lg ${viewMode === 'grid' ? 'bg-amber-700 text-white' : 'bg-white text-gray-500'}`}>
                    <FiGrid />
                  </button>
                  <button onClick={() => setViewMode('list')}
                    className={`p-2 rounded-lg ${viewMode === 'list' ? 'bg-amber-700 text-white' : 'bg-white text-gray-500'}`}>
                    <FiList />
                  </button>
                </div>
              </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-16 bg-white rounded-2xl">
                ...
                <button onClick={clearFilters}
                  className="px-6 py-3 bg-amber-700 text-white rounded-full">
                  Clear Filters
                </button>
              </div>
            ) : (
